...
(
    ...
    specialism_instance_progress_id  UUID PRIMARY KEY REFERENCES enrolment__specialism_instance_progress(id),
...
INSERT INTO public.enrolment__student_specialism (id, student_id, specialism_instance_progress_id)
